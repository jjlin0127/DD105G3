function doFirst(){
    ...
    //     fruitsItemsGroup[j].addEventListener('change', articleFilter);
    // };

    // conditionBtns = document.querySelectorAll('#filter_form .options input');
    // for (let i=0; i<conditionBtns.length; i++){
    //     conditionBtns[i].addEventListener('change', articleFilter);
    // };
};
...
//     let topicTypeValue = document.querySelector('input[name="topicType[]"]:checked').value;
//     let result = [];
//     switch(topicTypeValue){
//         case "1":
//             result = artiArrCopy.filter(item => item.topicType == 1);
//             break;
//         case "2":
//             result = artiArrCopy.filter(item => item.topicType == 2);
//             break;
//         case "3":
//             result = artiArrCopy.filter(item => item.topicType == 3);
//             break;
//         case "4":
//             result = artiArrCopy.filter(item => item.topicType == 4);
//             break;
//         default:
//             result = artiArrCopy;
//     };
...
//             var artiOriArr = JSON.parse(xhr.responseText);
//             // deep copy
//             artiArr = JSON.parse(JSON.stringify(artiOriArr));
//             // console.log(artiArr);

//             if(sort_by.value === "like"){
//                 artiArr.sort(function(a, b){
//                     return b.artLikeCount - a.artLikeCount;
//                 });
//             }else if(sort_by.value === "message"){
//                 artiArr.sort(function(a, b){
...
//     // let topicTypeValue = document.querySelector('input[name="topicType[]"]:checked').value
    // let fruitsItemsArr = [];		
    // for (let i=0; i<fruitsItemsGroup.length; i++){
    //     if(fruitsItemsGroup[i].checked){
    //         fruitsItemsArr.push(fruitsItemsGroup[i].value);
    //     };
    // };
//     // console.log(fruitsItemsArr);
...
//     // if(topicTypeValue == ""){
//         let result = [];
//         for(let j=0; j<fruitsItemsArr.length; j++){
//             // result.push(artiArr.filter(item => item.fruitsItems = fruitsItemsArr[j]))
//             result.push(filter({fruitsItems:fruitsItemsArr[j]}, artiArr));
//             // artiArr.filter(item => item.fruitsItems == fruitsItemsArr[j]);
//         }
//             console.log(result);
    //     }
    // }else{
    ...
    //         case "1":
    //         let result1 = [];
    //         result1.push(filter({topicType : 1}));
    //         for(let k=0; k<fruitsItemsArr.length; k++){
    //             result.push(filter({fruitsItems:fruitsItemsArr[k]}, artiArr));
    //         }
    //     }
    // }
    ...
    // console.log(artiArr);
    // let result = [];
    // result.push(artiArr.filter(item => item.topicType == "1"))
    // for(let j=0; j<topicTypeCheckArr.length; j++){
    //     result.push(artiArr.(item => item.topicType == topicTypeCheckArr[j]))
    // }
    // console.log(result);
        //  var condition = {topicType : topicTypeValue, fruitsItems : 4}
        //  console.log(filter(condition, artiArr));
// };
